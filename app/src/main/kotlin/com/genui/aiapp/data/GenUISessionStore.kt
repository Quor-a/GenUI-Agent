...
object GenUISessionStore {
    ...
    fun savePersonaId(ctx: Context, id: String) {
        prefs(ctx).edit().putString(KEY_PERSONA, id).apply()
    }

    fun loadPersonaId(ctx: Context): String =
        prefs(ctx).getString(KEY_PERSONA, "genui_expert") ?: "genui_expert"
